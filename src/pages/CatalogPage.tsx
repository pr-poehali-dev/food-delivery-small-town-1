...
const dishes = [
  ...
  { id: 21, name: 'НЛО-бургер с креветками', restaurant: 'Заправка Вкуса', price: 380, rating: 4.8, time: '25 мин', emoji: '🛸', category: 'НЛО-бургеры', popular: false },
  { id: 22, name: 'НЛО-бургер с бананом и нутеллой', restaurant: 'Заправка Вкуса', price: 270, rating: 4.6, time: '20 мин', emoji: '🛸', category: 'НЛО-бургеры', popular: false },
  ...
  { id: 23, name: 'Клубничный милкшейк', restaurant: 'Заправка Вкуса', price: 240, rating: 4.8, time: '7 мин', emoji: '🍓', category: 'Напитки', subcategory: 'Милкшейки', popular: true },
  { id: 24, name: 'Ванильный милкшейк', restaurant: 'Заправка Вкуса', price: 240, rating: 4.7, time: '7 мин', emoji: '🥛', category: 'Напитки', subcategory: 'Милкшейки', popular: false },
  { id: 25, name: 'Шоколадный милкшейк', restaurant: 'Заправка Вкуса', price: 240, rating: 4.8, time: '7 мин', emoji: '🍫', category: 'Напитки', subcategory: 'Милкшейки', popular: false },
  { id: 31, name: 'Карамельный милкшейк', restaurant: 'Заправка Вкуса', price: 240, rating: 4.7, time: '7 мин', emoji: '🍮', category: 'Напитки', subcategory: 'Милкшейки', popular: false },
  { id: 32, name: 'Дубайский милкшейк', restaurant: 'Заправка Вкуса', price: 240, rating: 4.9, time: '7 мин', emoji: '✨', category: 'Напитки', subcategory: 'Милкшейки', popular: false },
  { id: 33, name: 'Манговый милкшейк', restaurant: 'Заправка Вкуса', price: 240, rating: 4.8, time: '7 мин', emoji: '🥭', category: 'Напитки', subcategory: 'Милкшейки', popular: false },
  { id: 34, name: 'Кокосовый милкшейк', restaurant: 'Заправка Вкуса', price: 240, rating: 4.7, time: '7 мин', emoji: '🥥', category: 'Напитки', subcategory: 'Милкшейки', popular: false },
  { id: 26, name: 'Мохито', restaurant: 'Заправка Вкуса', price: 250, rating: 4.8, time: '5 мин', emoji: '🌿', category: 'Напитки', subcategory: 'Лимонады', popular: true },
  { id: 27, name: 'Клубничный мохито', restaurant: 'Заправка Вкуса', price: 250, rating: 4.9, time: '5 мин', emoji: '🍓', category: 'Напитки', subcategory: 'Лимонады', popular: false },
